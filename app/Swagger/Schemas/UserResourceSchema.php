...
#[OA\Schema(
    schema: 'UserResource',
    description: 'User resource (admin, or base for patient/doctor/receptionist)',
    properties: [
        ...
        new OA\Property(property: 'city_id', type: 'string', format: 'uuid', nullable: true, description: 'City UUID'),
