...
class RegisterReceptionistRequest extends FormRequest
{
    ...
    public function messages(): array
    {
        return [
            ...
            'shift_start.date_format' => __('auth_messages.shift_start_date_format'),
            'shift_end.date_format' => __('auth_messages.shift_end_date_format'),
        ];
    }
}
